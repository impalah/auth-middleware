from auth_middleware.providers.azure.utils import get_login_url, get_logout_url
...
class TestEntraIdUtils:
    ...
    def test_get_login_url_with_all_parameters(self):
        ...
        assert (
            "https%3A%2F%2Fexample.com%2Fcallback" in result
        )  # URL encoded redirect_uri with proper encoding
    ...
    def test_get_login_url_redirect_uri_encoding(self):
        ...
        assert (
            "https%3A%2F%2Fexample.com%2Fcallback%3Fparam%3Dvalue%26other%3Dtest"
            in result
        )
    ...
    def test_get_login_url_contains_required_parameters(self):
        ...
        result = get_login_url(
            tenant_id="tenant", client_id="client", redirect_uri="https://example.com"
        )
