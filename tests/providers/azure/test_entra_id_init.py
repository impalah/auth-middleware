from auth_middleware.providers.azure import (
    EntraIDProvider,
    get_login_url,
    get_logout_url,
)
...
class TestEntraIdInit:
    ...
    def test_entra_id_provider_import(self):
        ...
        from auth_middleware.providers.azure.entra_id_provider import (
            EntraIDProvider as DirectImport,
        )
    ...
    def test_utils_functions_import(self):
        ...
        from auth_middleware.providers.azure.utils import (
            get_login_url as DirectLoginImport,
        )
        from auth_middleware.providers.azure.utils import (
            get_logout_url as DirectLogoutImport,
        )
    ...
    def test_all_exports_defined(self):
        ...
        import auth_middleware.providers.azure as module
