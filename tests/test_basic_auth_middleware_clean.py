...
class TestBasicAuthMiddleware:
    ...
    def basic_auth_middleware(self, mock_credentials_repository):
        ...
        mock_app = Mock()
        return BasicAuthMiddleware(app=mock_app, credentials_repository=mock_credentials_repository)
    ...
    def user_credentials(self):
        ...
        return UserCredentials(
            ...
            name="testuser",
            hashed_password=hashed_password,  # Use hashed_password instead of password_hash
            groups=["admin", "user"]
        )
