...
class TestCLI:
    ...
    def test_get_permissions_command_exists(self):
        ...
        command = cli.get_command(
            None, "get-permissions"
        )  # Click automatically converts underscores to hyphens
    ...
    def test_get_permissions_command_execution(self, mock_provider_class):
        ...
        mock_provider.get_permissions_from_db.assert_called_once_with(
            username="testuser"
        )
    ...
    def test_cli_module_main_execution(self):
        ...
        with patch("auth_middleware.cli.cli"):
            ...
            with patch("__main__.__name__", "__main__"):
                ...
                exec(
                    compile(
                        open(auth_middleware.cli.__file__).read(),
                        auth_middleware.cli.__file__,
                        "exec",
                    )
                )
    ...
    def test_get_permissions_asyncio_run_called(
        self, mock_asyncio_run, mock_provider_class
    ):
        ...
        runner = CliRunner()
        runner.invoke(get_permissions, ["testuser"])
    ...
    def test_get_permissions_async_execution_success(self, mock_provider_class):
        ...
        mock_provider.get_permissions_from_db = AsyncMock(
    ...
    def test_click_echo_usage(self):
        ...
        with patch("auth_middleware.cli.SqlPermissionsProvider") as mock_provider_class:
            with patch("click.echo"):
                ...
                # Can't test click.echo directly (asyncio.run); verify command runs
                assert result.exit_code == 0
