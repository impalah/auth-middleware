...
class TestPermissionsChecker:
    ...
    def mock_user(self):
        ...
        user = User(id="test-id", name="testuser", email="test@example.com")
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_disabled_middleware(
        self, permissions_checker, mock_request
    ):
        """Test that checker returns early when middleware is disabled."""
        with patch(
            "auth_middleware.guards.permissions_checker.settings"
        ) as mock_settings:
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_no_current_user(
        self, permissions_checker, mock_request
    ):
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_missing_current_user_attribute(
        self, permissions_checker, mock_request
    ):
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_valid_permissions(
        self, permissions_checker, mock_request, mock_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_invalid_permissions(
        self, permissions_checker, mock_request, mock_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_multiple_valid_permissions(
        self, permissions_checker, mock_request, mock_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_none_permissions(
        self, permissions_checker, mock_request, mock_user
    ):
        ...
        with patch(
            ...
            with patch.object(mock_user, "_load_permissions", return_value=None):
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_empty_permissions(
        self, permissions_checker, mock_request, mock_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_permissions_checker_logging(
        self, permissions_checker, mock_request, mock_user
    ):
        ...
        with patch(
            ...
            with patch(
                "auth_middleware.guards.permissions_checker.logger"
            ) as mock_logger:
                mock_settings.AUTH_MIDDLEWARE_DISABLED = False
                mock_request.state.current_user = mock_user
    ...
    def test_permissions_checker_different_allowed_permissions(self):
        ...
        assert checker2._PermissionsChecker__allowed_permissions == [
            "execute",
            "delete",
        ]
