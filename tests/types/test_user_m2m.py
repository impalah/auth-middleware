...
class TestUserM2MExtensions:
    ...
    def m2m_jwt_token(self):
        ...
        token.__str__ = MagicMock(return_value="mock-m2m-token")  # type: ignore[method-assign]
        return token
    ...
    def user_jwt_token(self):
        ...
        token.__str__ = MagicMock(return_value="mock-user-token")  # type: ignore[method-assign]
        return token
