...
class IdentityPoolSettings(CognitoAuthzProviderSettings):
    ...
    Attributes:
        ...
        identity_pool_region: AWS region for Identity Pool (defaults to
            user_pool_region)
    ...
    Example:
        ```python
        from auth_middleware.providers.aws.identity_pool_settings import (
    ...
    @classmethod
    def set_default_region(cls, data: object) -> object:
    ...
    def validate_credentials_duration(self) -> IdentityPoolSettings:
