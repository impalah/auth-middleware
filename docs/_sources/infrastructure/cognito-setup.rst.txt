...
Use these values to configure your auth-middleware as described in the :doc:`../oidc_provider` documentation — point ``OidcProviderSettings.issuer`` at ``https://cognito-idp.{region}.amazonaws.com/{user_pool_id}``.
